...
const InteractiveChart: React.FC<InteractiveChartProps> = ({
  ...
  const drawChart = () => {
    ...
    requestAnimationFrame(() => {
      ...
      const planetRadius = isMobile ? 12 : 15;
      ...
      chartData.planets.forEach((planet) => {
        ...
        mainGroup
          ...
          .on("mouseover", function () {
            d3.select(this).attr("r", planetRadius + 3);
          })
          .on("mouseout", function () {
            d3.select(this).attr("r", planetRadius);
          })
          .on("focus", function () {
            d3.select(this)
  ...
  return (
    ...
    >
      ...
      {/* Chart Container */}
      <div
        className={`flex ${isMobile ? "flex-col" : "flex-col lg:flex-row"} gap-6`}
      >
        {/* SVG Chart */}
        <div className="flex-1 flex justify-center">
          ...
          <div id="chart-description" className="sr-only">
            Interactive astrological birth chart showing planetary positions in
            zodiac signs and houses. Use tab to navigate between planets and
            houses, press Enter or Space to select elements for detailed
            information.
          </div>
        </div>
