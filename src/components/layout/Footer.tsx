    ...
    <footer className="bg-dark-950 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-dark-300 text-sm">
              Your cosmic guide to inner wisdom. Explore spiritual insights,
              tarot readings, horoscopes, and astrology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Magazine", "Podcasts", "Tarot", "Horoscopes", "Shop"].map(
                (item) => (
                  <li key={item}>
                    <Link
                      to={`/${item.toLowerCase()}`}
              ...
              <li>
                ...
                >
                  Submit your podcast
                  <span className="inline-block ml-1 text-xs bg-accent-500 text-white px-1.5 py-0.5 rounded">
                    New
                  </span>
                </Link>
              </li>
          ...
          <div>
            ...
            <p className="text-dark-300 text-sm mb-4">
              Subscribe to receive cosmic updates, spiritual insights, and
              exclusive content.
            </p>
        ...
        <div className="mt-10 pt-8 border-t border-dark-700 text-center text-sm text-dark-400">
          <p>
            &copy; {new Date().getFullYear()} MysticBanana. All rights reserved.
          </p>
          <p className="mt-1">
            <Link
              to="/privacy-policy"
